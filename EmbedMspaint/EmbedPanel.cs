...
namespace EmbedMspaint
{
    ...
    public partial class EmbedPanel : Panel
    {
        ...
        public void Start(string appFile, string arguments = "")
        {
            ...
            try
            {
                ProcessStartInfo info = new ProcessStartInfo(AppFile, arguments);
            ...
            catch (Exception ex)
            {
                ...
                if (_AppProcess != null)
                {
                    if (!_AppProcess.HasExited) _AppProcess.Kill();
                    _AppProcess = null;
                }
            }
        }
